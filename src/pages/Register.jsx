...
import { auth, googleProvider, signInWithPopup, createUserWithEmailAndPassword, updateProfile } from "../firebase-config";
  ...
  return (
    <div className="relative font-['SF Pro'] flex flex-col min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage:
            "linear-gradient(45deg, black, gray, white)",
